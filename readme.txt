[this is a fork used for testing the Rust rtklib-ffi crate. This exposes additional functions for export, and removes history and large blobs to improve build speed.]
